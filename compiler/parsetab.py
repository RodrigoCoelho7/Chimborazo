...
_lr_productions = [
  ...
  ('declF -> FUNCION ID ( ) : ENTERO ENTER declarationsF statementsI TAB DEVUELVE return','declF',12,'p_declF_vazia','yacc.py',106),
  ('parametros -> ID : tipo','parametros',3,'p_parametros_1','yacc.py',110),
  ('parametros -> parametros , ID : tipo','parametros',5,'p_parametros_mult','yacc.py',114),
  ('declarationsF -> TAB decl','declarationsF',2,'p_declarationsF_1','yacc.py',118),
  ('declarationsF -> declarationsF TAB decl','declarationsF',3,'p_declarationsF_mult','yacc.py',121),
  ('return -> INT ENTER','return',2,'p_return_INT','yacc.py',124),
  ('return -> ID ENTER','return',2,'p_return_ID','yacc.py',127),
  ('statementsI -> TAB stat','statementsI',2,'p_statementsI_1','yacc.py',134),
  ('statementsI -> statementsI TAB stat','statementsI',3,'p_statementsI_mult','yacc.py',137),
  ('statements -> stat','statements',1,'p_statements_1','yacc.py',140),
  ('statements -> statements stat','statements',2,'p_statements_mult','yacc.py',143),
  ('stat -> atrib ENTER','stat',2,'p_stat_atrib','yacc.py',146),
  ('stat -> conditions','stat',1,'p_stat_conditions','yacc.py',149),
  ('stat -> ciclos','stat',1,'p_stat_ciclos','yacc.py',152),
  ('atrib -> ID = exp','atrib',3,'p_atrib','yacc.py',157),
  ('exp -> exp + termo','exp',3,'p_exp_soma','yacc.py',160),
  ('exp -> exp - termo','exp',3,'p_exp_sub','yacc.py',163),
  ('exp -> termo','exp',1,'p_exp_termo','yacc.py',166),
  ('termo -> termo * fator','termo',3,'p_termo_mul','yacc.py',169),
  ('termo -> termo / fator','termo',3,'p_termo_div','yacc.py',172),
  ('termo -> termo ^ fator','termo',3,'p_termo_pot','yacc.py',175),
  ('termo -> fator','termo',1,'p_termo_fator','yacc.py',178),
  ('fator -> INT','fator',1,'p_fator_INT','yacc.py',181),
  ('fator -> FLOAT','fator',1,'p_fator_FLOAT','yacc.py',184),
  ('fator -> ID','fator',1,'p_fator_ID','yacc.py',187),
  ('fator -> ( exp )','fator',3,'p_fator_exp','yacc.py',190),
  ('conditions -> SI expL ENTONCES ENTER statementsI','conditions',5,'p_conditions_si','yacc.py',197),
  ('conditions -> SI expL ENTONCES ENTER statementsI SI NO ENTER statementsI','conditions',9,'p_conditions_si_no','yacc.py',200),
  ('expL -> termoB','expL',1,'p_expL_1','yacc.py',203),
  ('expL -> expL OR termoB','expL',3,'p_expL_mult','yacc.py',206),
  ('termoB -> fatorB','termoB',1,'p_termoB_1','yacc.py',209),
  ('termoB -> termoB AND fatorB','termoB',3,'p_termoB_mult','yacc.py',212),
  ('fatorB -> condition','fatorB',1,'p_fatorB_condition','yacc.py',215),
  ('fatorB -> BOOLEANO','fatorB',1,'p_fatorB_BOOL','yacc.py',218),
  ('fatorB -> ( expL )','fatorB',3,'p_fatorB_expL','yacc.py',221),
  ('condition -> exp op exp','condition',3,'p_condition','yacc.py',224),
  ('op -> >','op',1,'p_op_maior','yacc.py',227),
  ('op -> <','op',1,'p_op_menor','yacc.py',230),
  ('op -> IGUAL','op',1,'p_op_IGUAL','yacc.py',233),
  ('op -> DIFERENTE','op',1,'p_op_DIFERENTE','yacc.py',236),
  ('op -> > IGUAL','op',2,'p_op_maiorIGUAL','yacc.py',239),
  ('op -> < IGUAL','op',2,'p_op_menorIGUAL','yacc.py',242),
  ('ciclos -> ENCUANTO expL HACER ENTER statementsI','ciclos',5,'p_ciclos_while','yacc.py',249),
  ('ciclos -> PARA expL SIGUIENTE atrib . ENTER','ciclos',6,'p_ciclos_for_1','yacc.py',252),
  ('ciclos -> PARA expL SIGUIENTE atrib HACER ENTER statementsI','ciclos',7,'p_ciclos_for_mult','yacc.py',255),
]
